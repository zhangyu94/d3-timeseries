    ...
    d3.linechart = function() {
        ...
        function chart(selection) {
            ...
            selection.each(function(dataset_lines) {
                ...
                function draw_mouseoverpoint(x_value, y_value, id, circle_color = '#80B0FF', r = 5) {
                    var flag_new_point = g.select('#' + id).node() == null
                    if (flag_new_point) {
                        g.append('circle')
                            .attr('id', id)
                    ...
                    if (!flag_new_point)
                        point = point.transition().duration(2)
                ...
                function draw_mouseovertip(x_value, y_value, id, tip_color = '#80B0FF') {
                    ...
                    let [anchor_top, anchor_left] = [parent.offset().top, parent.offset().left]
